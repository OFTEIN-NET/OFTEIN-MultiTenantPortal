...
passport.use(new FacebookStrategy({
        ...
        callbackURL: 'https://oftein.iotcloudserve.net/auth/facebook/callback',
...
passport.use(new LinkedinStrategy({
        ...
        callbackURL: 'https://oftein.iotcloudserve.net/auth/linkedin/callback',
...
passport.use(new GoogleStrategy({
        ...
        callbackURL: 'https://oftein.iotcloudserve.net/auth/google/callback'
    },
    (accessToken, refreshToken, profile, cb) => {
        return cb(null, profile);
    }));
